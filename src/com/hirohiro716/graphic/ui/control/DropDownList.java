...
public class DropDownList<T> extends ListSelectControl<T> {
    ...
    private com.hirohiro716.graphic.ui.collection.Collection<T> itemsForInitialization = new com.hirohiro716.graphic.ui.collection.Collection<>();
        
    @Override
    public com.hirohiro716.graphic.ui.collection.Collection<T> getItems() {
